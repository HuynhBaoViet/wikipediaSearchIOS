...
//        NSDictionary *parameters = @{@"key_word":searchText,
//                                     @"page":@"1",
//                                     @"type":@"all"
//                                     };
//        
...
//        
//        [manager GET:@"https://dev.freshspoke.com/local_food_champ/mobile/searchpage?" parameters:parameters success:^(NSURLSessionTask *task, id responseObject) {
